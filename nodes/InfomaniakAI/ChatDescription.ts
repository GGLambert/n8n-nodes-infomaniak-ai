		...
		options: [
			{
				...
				routing: {
					request: {
						method: 'POST',
						url: '{{$credentials.productId}}/openai/chat/completions',
					},
...
const completeOperations: INodeProperties[] = [
	{
		...
		type: 'options',
		description:
			'The model which will generate the completion. <a href="https://developer.infomaniak.com/docs/api/post/1/ai/{product_id}/openai/chat/completions">Learn more</a>.',
		displayOptions: {
			show: {
				operation: ['complete'],
				resource: ['chat'],
